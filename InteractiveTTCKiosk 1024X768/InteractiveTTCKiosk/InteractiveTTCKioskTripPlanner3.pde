...
void interactiveTTCKioskTripPlanner3Setup()
{
  ...
  imageZoneTripPlanner3Background.setSize(1024,768);
  SMT.add(imageZoneTripPlanner3Background);
  
  // Add the navigations as child zones of the main screen zone
  imageZoneTripPlanner3TurnByTurn.setSize (Math.round(1024/3.5), Math.round(768/2));
  imageZoneTripPlanner3Background.add(imageZoneTripPlanner3TurnByTurn);
  
  imageZoneTripPlanner3Print.setSize (Math.round(1024/3.5), Math.round(768/2));
  imageZoneTripPlanner3Background.add(imageZoneTripPlanner3Print);
  
  imageZoneTripPlanner3Back.setSize (Math.round(1024/14.5), Math.round(768/2));
  imageZoneTripPlanner3Background.add(imageZoneTripPlanner3Back);
  
  imageZoneTripPlanner3Exit.setSize (Math.round(1024/14.25), Math.round(768/10.25));
...
void drawTripPlanner3TurnByTurn( Zone zone )
{
  ...
  image (TripPlanner3TurnByTurn, 1024/2-450, 768/2-200) ;
}
...
void drawTripPlanner3Print( Zone zone )
{
  ...
  image (TripPlanner3Print , 1024/2+100, 768/2-200) ;
}
