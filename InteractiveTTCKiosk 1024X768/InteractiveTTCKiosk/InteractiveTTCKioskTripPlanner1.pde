...
void interactiveTTCKioskTripPlanner1Setup()
{
  ...
  imageZoneTripPlanner1Background.setSize(1024,768);
  SMT.add(imageZoneTripPlanner1Background);
  
  // Add the navigations as child zones of the main screen zone
  imageZoneTripPlanner1StatingLocation.setSize (Math.round(1024/1.3), Math.round(768/5.50));
  imageZoneTripPlanner1Background.add(imageZoneTripPlanner1StatingLocation);
  
  imageZoneTripPlanner1Destination.setSize (Math.round(1024/1.3), Math.round(768/5.50));
  imageZoneTripPlanner1Background.add(imageZoneTripPlanner1Destination);
  
  imageZoneTripPlanner1ValidAddress.setSize (Math.round(1024/10.25), Math.round(768/5.50));
  imageZoneTripPlanner1Background.add(imageZoneTripPlanner1ValidAddress);
  
  imageZoneTripPlanner1Back.setSize (Math.round(1024/14.5), Math.round(768/2));
  imageZoneTripPlanner1Background.add(imageZoneTripPlanner1Back);
  
  imageZoneTripPlanner1Exit.setSize (Math.round(1024/14.25), Math.round(768/10.25));
  imageZoneTripPlanner1Background.add(imageZoneTripPlanner1Exit);
  
  keyboard.setLocation( 1024/2-575, 768/2);
...
void drawTripPlanner1StatingLocation( Zone zone )
{
  ...
  image (tripPlannerStartingLocation, 1024/2-620, 768/2-300) ;
}
...
void drawTripPlanner1Destination( Zone zone )
{
  ...
  image (tripPlannerDestination , 1024/2-620, 768/2-125) ;
...
{
  rect(1024/2-620, 768/2-125, zone.width, zone.height);
}
...
void drawTripPlanner1ValidAddress( Zone zone )
{
  ...
  image (tripPlannerValidAddress , 1024/2+630, 768/2-125) ;
}

void pickDrawTripPlanner1ValidAddress ( Zone zone )
{
  rect(1024/2+630, 768/2-125, zone.width, zone.height);
}
