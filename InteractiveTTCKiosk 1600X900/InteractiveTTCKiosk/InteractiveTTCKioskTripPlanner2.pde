...
void interactiveTTCKioskTripPlanner2Setup()
{
  ...
  imageZoneTripPlanner2Background.setSize(displayWidth,displayHeight);
  SMT.add(imageZoneTripPlanner2Background);
  
  // Add the navigations as child zones of the main screen zone
  imageZoneTripPlanner2RouteCheap.setSize (Math.round(displayWidth/5), Math.round(displayHeight/1.50));
  imageZoneTripPlanner2Background.add(imageZoneTripPlanner2RouteCheap);
  
  imageZoneTripPlanner2RouteFast.setSize (Math.round(displayWidth/5), Math.round(displayHeight/1.50));
  imageZoneTripPlanner2Background.add(imageZoneTripPlanner2RouteFast);
  
  imageZoneTripPlanner2RouteBest.setSize (Math.round(displayWidth/5), Math.round(displayHeight/1.50));
  imageZoneTripPlanner2Background.add(imageZoneTripPlanner2RouteBest);
  
  imageZoneTripPlanner2Back.setSize (Math.round(displayWidth/14.5), Math.round(displayHeight/2));
  imageZoneTripPlanner2Background.add(imageZoneTripPlanner2Back);
  
  imageZoneTripPlanner2Exit.setSize (Math.round(displayWidth/14.25), Math.round(displayHeight/10.25));
...
void drawTripPlanner2RouteCheap( Zone zone )
{
  ...
  image (tripPlanner2RouteCheap, displayWidth/2-550, displayHeight/2-300) ;
}

void pickDrawTripPlanner2RouteCheap ( Zone zone )
{
  rect(displayWidth/2-550, displayHeight/2-300, zone.width, zone.height);
}
...
void drawTripPlanner2RouteFast( Zone zone )
{
  ...
  image (tripPlanner2RouteFast , displayWidth/2-130, displayHeight/2-300) ;
}

void pickDrawTripPlanner2RouteFast ( Zone zone )
{
  rect(displayWidth/2-130, displayHeight/2-300, zone.width, zone.height);
}
...
void drawTripPlanner2RouteBest( Zone zone )
{
  ...
  image (tripPlanner2RouteBest , displayWidth/2+290, displayHeight/2-300) ;
}

void pickDrawTripPlanner2RouteBest ( Zone zone )
{
  rect(displayWidth/2+290, displayHeight/2-300, zone.width, zone.height);
}
