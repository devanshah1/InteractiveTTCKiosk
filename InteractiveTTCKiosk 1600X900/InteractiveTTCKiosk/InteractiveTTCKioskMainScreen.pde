...
void interactiveTTCKioskMainScreenSetup()
{
  ...
  imageZoneMainScreenBackground.setSize(displayWidth,displayHeight);
  ...
  imageZoneMainScreenTripPlanner.setSize (Math.round(displayWidth/6.25), Math.round(displayHeight/3.50));
  imageZoneMainScreenBackground.add(imageZoneMainScreenTripPlanner);
  
  imageZoneMainScreenPointOfInterest.setSize (Math.round(displayWidth/6.25), Math.round(displayHeight/3.50));
  imageZoneMainScreenBackground.add(imageZoneMainScreenPointOfInterest);
  
  imageZoneMainScreenServiceUpdate.setSize (Math.round(displayWidth/6.25), Math.round(displayHeight/3.50));
  imageZoneMainScreenBackground.add(imageZoneMainScreenServiceUpdate);
  
  imageZoneMainScreenSubwaySystemStatusMap.setSize (Math.round(displayWidth/6.25), Math.round(displayHeight/3.50));
  imageZoneMainScreenBackground.add(imageZoneMainScreenSubwaySystemStatusMap);
  
  imageZoneMainScreenBusSystemStatusMap.setSize (Math.round(displayWidth/6.25), Math.round(displayHeight/3.50));
  imageZoneMainScreenBackground.add(imageZoneMainScreenBusSystemStatusMap);
  
  imageZoneMainScreenStationMapAndInformation.setSize (Math.round(displayWidth/6.25), Math.round(displayHeight/3.50));
...
void drawMainScreenTripPlanner( Zone zone )
{
  ...
  image (mainScreenTripPlanner, displayWidth/2-780, displayHeight/2-275) ;
}

void pickDrawMainScreenTripPlanner ( Zone zone )
{
  rect(displayWidth/2-780, displayHeight/2-275, zone.width, zone.height);
}
...
void drawMainScreenPointOfInterest( Zone zone )
{
  ...
  image (mainScreenPointOfInterest , displayWidth/2-120, displayHeight/2-275) ;
}

void pickDrawMainScreenPointOfInterest ( Zone zone )
{
  rect(displayWidth/2-120, displayHeight/2-275, zone.width, zone.height);
}
...
void drawMainScreenServiceUpdate( Zone zone )
{
  ...
  image (mainScreenServiceUpdate , displayWidth/2+520, displayHeight/2-275) ;
}

void pickDrawMainScreenServiceUpdate ( Zone zone )
{
  rect(displayWidth/2+520, displayHeight/2-275, zone.width, zone.height);
}
...
void drawMainScreenSubwaySystemStatusMap( Zone zone )
{
  ...
  image (mainScreenSubwaySystemStatusMap , displayWidth/2-780, displayHeight/2+50) ;
}

void pickDrawMainScreenSubwaySystemStatusMap ( Zone zone )
{
  rect(displayWidth/2-780, displayHeight/2+50, zone.width, zone.height);
}
...
void drawMainScreenBusSystemStatusMap( Zone zone )
{
  ...
  image (mainScreenBusSystemStatusMap , displayWidth/2-120, displayHeight/2+50) ;
}

void pickDrawMainScreenBusSystemStatusMap ( Zone zone )
{
  rect(displayWidth/2-120, displayHeight/2+50, zone.width, zone.height);
}
...
void drawMainScreenStationMapAndInformation( Zone zone )
{
  ...
  image (mainScreenStationMapAndInformation , displayWidth/2+520, displayHeight/2+50) ;
}

void pickDrawMainScreenStationMapAndInformation ( Zone zone )
{
  rect(displayWidth/2+520, displayHeight/2+100, zone.width, zone.height);
}
